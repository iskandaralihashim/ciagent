...
<div class="row">
    <div class="col-md-8 offset-md-2">
        ...
        <form method="POST" action="<?= base_url('/items/' . $item['id'] . '/update') ?>" class="needs-validation" novalidate>
            <?= csrf_field() ?>
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <input type="number" class="form-control" id="price" name="price" step="0.01" min="0" value="<?= old('price', $item['price']) ?>" required>
            ...
            <div class="d-flex gap-2">
                ...
                <a href="<?= base_url('/items/' . $item['id']) ?>" class="btn btn-secondary btn-lg">Cancel</a>
            </div>
        </form>
    </div>
</div>
